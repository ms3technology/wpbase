...
function maxAdminMenu(){
  ...
  add_submenu_page('managements', 'Bulk Student', 'Bulk Student', 'manage_options', 'bulkstudent', 'bulkStudentManagement');
  function bulkStudentManagement(){  require_once ('adminPages/bulk-student.php'); }

  /*Fast Student Entry*/
  add_submenu_page('managements', 'Fast Entry', 'Fast Entry', 'manage_options', 'fastentry', 'fastEntryManagement');
  function fastEntryManagement(){  require_once ('adminPages/fast-entry.php'); }
